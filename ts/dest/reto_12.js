...
function selectSleigh(distance, sleighs) {
    const bestSleigh = sleighs.filter((sleigh) => sleigh.consumption * distance <= 20);
    return bestSleigh.length === 0
        ? null
        : bestSleigh[bestSleigh.length - 1].name;
}
const distance = 10;
const sleighs = [
...
console.log(selectSleigh(distance2, sleighs2));
